...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func formatDate() -> String {
        ...
        dataFormater.dateFormat = "yyyy-MM-dd HH:mm:ssZZZ"
        return dataFormater.stringFromDate(NSDate())
    ...
    func insertNewObject(sender: AnyObject) {
        ...
        let documentToCreate = KLDocument(fileURL: url)
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        let documentToOpen = UIDocument(fileURL: documentURLs[indexPath.row])
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "showDetail" {
            ...
            controller.detailItem = sender as! KLDocument
